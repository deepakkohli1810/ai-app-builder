...
import { Code, Code2, Eye, Files } from "lucide-react";
import {
  Tabs,
  TabsList,
  TabsTrigger,
...
function SandpackInner({
 ...
 //--Push files updates into Sandpack without remounting ---
 //We key SandpackerProvider on the file PATH SET only .
       ...
       >
         ...
         >
           ...
           <SandpackCodeEditor
             ...
             closableTabs
             readOnly
             // readOnly --users can modify the code through the prompt not in the code editor
           />
         </TabsContent>
       </SandpackLayout>
     </div>
  ...
  CodePanelProps) {
    ...
    return(
     <div className="flex flex-1 flex-col overflow-hidden">
      ...
      options={
       {
        //Tailwind v3 CDN - injected every preview frame 
